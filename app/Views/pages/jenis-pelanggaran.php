...
<style>
  ...
  .search-input { background: var(--surface-soft); border: 1px solid var(--border-subtle); border-radius: 10px; padding: 10px 16px 10px 40px; font-size: 14px; color: var(--text-strong); width: 260px; transition: all 0.2s; }
  .search-input:focus { outline: none; border-color: #E11D48; box-shadow: 0 0 0 3px rgba(225,29,72,0.1); }

  .filter-select { background: var(--surface-soft); border: 1px solid var(--border-subtle); border-radius: 10px; padding: 10px 14px; font-size: 14px; color: var(--text-strong); transition: all 0.2s; font-family: 'DM Sans'; }
  .filter-select:focus { outline: none; border-color: #E11D48; }
