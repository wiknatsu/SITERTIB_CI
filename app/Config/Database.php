...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        // Set live database configuration from environment variables.
        ...
        $this->default['pConnect'] = filter_var(env('database.default.pConnect', $this->default['pConnect']), FILTER_VALIDATE_BOOLEAN);
        $this->default['DBDebug'] = filter_var(env('database.default.DBDebug', ENVIRONMENT !== 'production'), FILTER_VALIDATE_BOOLEAN);
